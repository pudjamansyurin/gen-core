...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_IN8 
    */
    GPIO_InitStruct.Pin = EXT_ADC1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(EXT_ADC1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PB1     ------> ADC2_IN9 
    */
    GPIO_InitStruct.Pin = EXT_ADC2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(EXT_ADC2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8 
    */
    HAL_GPIO_DeInit(EXT_ADC1_GPIO_Port, EXT_ADC1_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9 
    */
    HAL_GPIO_DeInit(EXT_ADC2_GPIO_Port, EXT_ADC2_Pin);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN1_MspDeInit 0 */
    ...
    PD1     ------> CAN1_TX 
    */
    HAL_GPIO_DeInit(GPIOD, INT_CAN_RX_Pin|INT_CAN_TX_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    PB11     ------> I2C2_SDA 
    */
    GPIO_InitStruct.Pin = INT_EEPROM_SCL_Pin|INT_EEPROM_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> I2S3_SD 
    */
    HAL_GPIO_DeInit(INT_AUDIO_LRCK_GPIO_Port, INT_AUDIO_LRCK_Pin);

    HAL_GPIO_DeInit(GPIOC, INT_AUDIO_MCLK_Pin|INT_AUDIO_SCLK_Pin|INT_AUDIO_SDIN_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI 
    */
    HAL_GPIO_DeInit(GPIOA, INT_KEYLESS_SCK_Pin|INT_KEYLESS_MISO_Pin|INT_KEYLESS_MOSI_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PA1     ------> UART4_RX 
    */
    GPIO_InitStruct.Pin = INT_FINGER_TX_Pin|INT_FINGER_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA1     ------> UART4_RX 
    */
    HAL_GPIO_DeInit(GPIOA, INT_FINGER_TX_Pin|INT_FINGER_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX 
    */
    HAL_GPIO_DeInit(GPIOA, INT_GPS_TX_Pin|INT_GPS_RX_Pin);
