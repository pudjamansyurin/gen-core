...
#define BMS_IRQ_Pin GPIO_PIN_13
#define BMS_IRQ_GPIO_Port GPIOC
#define BMS_IRQ_EXTI_IRQn EXTI15_10_IRQn
...
#define NRF24_PWR_Pin GPIO_PIN_0
#define NRF24_PWR_GPIO_Port GPIOC
...
#define SPEEDO_PWR_Pin GPIO_PIN_4
#define SPEEDO_PWR_GPIO_Port GPIOC
#define MIRROR_PWR_Pin GPIO_PIN_5
#define MIRROR_PWR_GPIO_Port GPIOC
#define MIRROR_LIGHT_Pin GPIO_PIN_0
#define MIRROR_LIGHT_GPIO_Port GPIOB
#define COOLING_PWR_Pin GPIO_PIN_1
#define COOLING_PWR_GPIO_Port GPIOB
