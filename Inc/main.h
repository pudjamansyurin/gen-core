...
#define INT_FINGER_TOUCH_PWR_Pin GPIO_PIN_2
#define INT_FINGER_TOUCH_PWR_GPIO_Port GPIOC
#define INT_FINGER_PWR_Pin GPIO_PIN_3
#define INT_FINGER_PWR_GPIO_Port GPIOC
#define INT_FINGER_TX_Pin GPIO_PIN_0
#define INT_FINGER_TX_GPIO_Port GPIOA
#define INT_FINGER_RX_Pin GPIO_PIN_1
#define INT_FINGER_RX_GPIO_Port GPIOA
...
#define EXT_HMI2_BRIGHTNESS_Pin GPIO_PIN_0
#define EXT_HMI2_BRIGHTNESS_GPIO_Port GPIOB
#define EXT_HMI2_SHUTDOWN_Pin GPIO_PIN_1
#define EXT_HMI2_SHUTDOWN_GPIO_Port GPIOB
#define EXT_SOLENOID_PWR_Pin GPIO_PIN_2
#define EXT_SOLENOID_PWR_GPIO_Port GPIOB
#define INT_FINGER_IRQ_Pin GPIO_PIN_7
#define INT_FINGER_IRQ_GPIO_Port GPIOE
#define INT_FINGER_IRQ_EXTI_IRQn EXTI9_5_IRQn
...
#define INT_EEPROM_SDA_Pin GPIO_PIN_11
...
#define INT_AUDIO_SDA_Pin GPIO_PIN_9
