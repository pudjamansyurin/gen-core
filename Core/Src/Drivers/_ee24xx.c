...
#if ((EEPROM_SIZE_KBIT==1) || (EEPROM_SIZE_KBIT==2))
  if(HAL_I2C_Mem_Write(&hi2c2,DevAddress,Address,I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,size_of_data,100) == HAL_OK) {
#elif   (EEPROM_SIZE_KBIT==4)
  if(HAL_I2C_Mem_Write(&hi2c2,DevAddress|((Address&0x0100>>7)),(Address&0xff),I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,size_of_data,100) == HAL_OK) {
...
#if ((EEPROM_SIZE_KBIT==1) || (EEPROM_SIZE_KBIT==2))
  if(HAL_I2C_Mem_Read(&hi2c2,DevAddress,Address,I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,size_of_data,100) == HAL_OK) {
#elif (EEPROM_SIZE_KBIT==4)
  if(HAL_I2C_Mem_Read(&hi2c2,DevAddress|((Address&0x0100>>7)),(Address&0xff),I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,size_of_data,100) == HAL_OK) {
#elif (EEPROM_SIZE_KBIT==8)
