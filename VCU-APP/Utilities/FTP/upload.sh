...
curl -T $APP_BIN_FILE ftp://ftp.genmotorcycles.com/vcu/ --user 'fota@genmotorcycles.com:@Garda313'
echo "FTP checksum uploading..."
curl -T $APP_CRC_FILE ftp://ftp.genmotorcycles.com/vcu/ --user 'fota@genmotorcycles.com:@Garda313'
