...
typedef enum {
    NRF_TX_PWR_M18dBm = 0, NRF_TX_PWR_M12dBm = 1, NRF_TX_PWR_M6dBm = 2, NRF_TX_PWR_0dBm = 3
} NRF_TX_PWR;
...
NRF_RESULT nrf_send_command(NRF_COMMAND cmd, const uint8_t *tx, uint8_t *rx, uint8_t len);
