...
typedef enum {
  ...
  MPU6050_Result_DeviceNotConnected, /*!< There is no device with valid slave
                                        address */
 ...
 * should be MPU6050_Device_0, but if AD0 pin is high, then you should use
 * MPU6050_Device_1
 *
 *          Parameter can be a value of @ref MPU6050_Device_t enumeration
 * @param  AccelerometerSensitivity: Set accelerometer sensitivity. This
 * parameter can be a value of @ref MPU6050_Accelerometer_t enumeration
 * @param  GyroscopeSensitivity: Set gyroscope sensitivity. This parameter can
 * be a value of @ref MPU6050_Gyroscope_t enumeration
 ...
 * @param  *DataStruct: Pointer to @ref MPU6050_t structure indicating MPU6050
 * device
 * @param  GyroscopeSensitivity: Gyro sensitivity value. This parameter can be a
 ...
 * @param  *DataStruct: Pointer to @ref MPU6050_t structure indicating MPU6050
 * device
 * @param  AccelerometerSensitivity: Gyro sensitivity value. This parameter can
 ...
 * @param  *DataStruct: Pointer to @ref MPU6050_t structure indicating MPU6050
 * device
 * @param  *InterruptsStruct: Pointer to @ref MPU6050_Interrupt_t structure to
 * store status in
 * @retval Member of @ref MPU6050_Result_t enumeration
 */
